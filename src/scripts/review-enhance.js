...
/* Astro's markdown renderer generates id from heading text;
   look for the "목차" heading by both possible id formats */
const tocHeading =
	contentRoot.querySelector('h2[id="%EB%AA%A9%EC%B0%A8"]') ||
	contentRoot.querySelector('h2[id="목차"]');
