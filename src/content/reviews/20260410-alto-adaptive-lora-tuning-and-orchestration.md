---
title: "ALTO: 이기종 LoRA 학습 워크로드를 위한 적응적 튜닝 및 오케스트레이션 -- 종합 분석 보고서"
originalTitle: "ALTO: Adaptive LoRA Tuning and Orchestration for Heterogeneous LoRA Training Workloads"
date: 2026-04-10
authors: "Jingwei Zuo, Xinze Feng, Zien Liu, Kaijian Wang, Fanjiang Ye, Ye Cao, Zhuang Wang, Yuke Wang"
institution: "Rice University"
tags: ["LoRA", "hyperparameter-tuning", "distributed-training", "GPU-scheduling", "multi-LoRA"]
description: "다중 LoRA 하이퍼파라미터 튜닝을 통합 시스템 워크로드로 재구성하여, 조기 종료, 배치 실행, 어댑터 병렬화, 계층적 스케줄링으로 최대 13.8배 속도 향상을 달성하는 ALTO 시스템 분석"
---
